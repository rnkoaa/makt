...
public abstract class AbstractAnnotationProcessor extends AbstractProcessor {
    ...
    protected static void readOldIndexFile(Collection<String> entries, Reader reader) throws IOException {
    ...
    protected void writeIndexFile(Collection<String> entries, String resourceName, FileObject overrideFile)
            throws IOException {
